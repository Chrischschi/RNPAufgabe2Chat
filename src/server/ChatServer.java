...
public class ChatServer {
	...
	public static void main(String[] args) {
		...
		int counter = 0; //ZÃ¤hlt die erzeugten Bearbeitungs-Threads
...
//und startet einen neuen Arbeits-Thread fÃ¼r jede Verbindung,
	class ChatServerWorkThread extends java.lang.Thread {
		...
		ChatServer assocSrv; //Der server, zu dem der server-thread gehÃ¶rt
		 ...
		 * verantwortet. Fehler kÃ¶nnen bei falschen 
		...
		private void doInfo() throws IOException {
				...
				msgBuilder.append("\n"); //nachricht mit newline abschlieÃŸen
		...
		private void writeToClientErr(String reply) throws IOException {
			 ...
			 * log wird auf System.err ausgegeben, fÃ¼r fehlernachrichten! */
